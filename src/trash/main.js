...
function goback(){
    console.log("the goback function is called in javascript side..");
    window.history.back();
}

function goforward(){
    console.log("the goforward function is called in javascript side..")
    window.history.forward();
}


//eel.expose(navigate);
// Add these lines in your JavaScript
eel.expose(goback);
eel.expose(goforward);*/
...
console.log("Navigation functions check:", {
    ...
    goback: typeof goback !== 'undefined',
    goforward: typeof goforward !== 'undefined'
});